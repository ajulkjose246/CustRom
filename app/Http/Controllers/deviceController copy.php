...
class deviceController extends Controller
{
...

    {
        ...
        return view('customroms', ['devices' => [
            ...
            'Baikalos' => [
                'url' => 'https://sourceforge.net/projects/baikalos/files/' . $id . '/',
                'boolean' => $baikalos
            ],
            'Hyper OS' => [
            ...
            'Superior OS' => [
                'url' => 'https://sourceforge.net/projects/superioros/files/' . $id . '/',
                'boolean' => $superioros
            ],
            'Lineage OS' => [
            ...
            'Project Matrixx' => [
                'url' => 'https://sourceforge.net/projects/projectmatrixx/files/Android-14/' . $id . '/',
